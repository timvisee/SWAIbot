...
String SWAIProtocol::serialize(SWAIPacket p) {
	...
	// Calculate the count of arrays being send
	int arrCount = p.getArrayCount();

	// Print the amount of arrays being send
	s += arrCount;
...
SWAIPacket SWAIProtocol::deserialize(String s) {
